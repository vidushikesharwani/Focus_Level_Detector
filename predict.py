# ============================================================
# FILE: predict.py
# PURPOSE: Predict focus score + give suggestions
...
# ============================================================
# STEP 4.1 → Load the saved trained model
...
try:
    ...
    # ============================================================
    # STEP 4.4 → Predict using the ML model
    # ============================================================
    ...
    # ============================================================
    # STEP 4.6 → Save this entry to weekly tracker CSV
    # This builds up your personal daily log over time
    # ============================================================
